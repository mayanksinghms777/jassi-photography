...
function Navbar() {
    ...
    return (
        ...
        <div className="mobile-navbar container-fluid">
            ...
            <span className="nav-icon mobile-white" onClick={openNav}><span style={{fontSize:'1.1rem', marginRight:'8px', verticalAlign:'-0.1em'}}>MENU</span>&#9776;</span>
        </div>
